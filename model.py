...
def model(X_train, y_train, X_test):
    ...
    subprocess.call("luajit model_generic.lua --train %s --test %s --outputproba %s --outputtargets %s" % (train_tmp_file.name, test_tmp_file.name, proba_tmp_file.name, targets_tmp_file.name), shell=True)
